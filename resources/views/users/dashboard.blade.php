        ...
        fetch('/users/clientes/' + id)
            ...
            .then(data => {
                ...
                data.forEach(client => {
                    ...
                    row.innerHTML = `
                        <td style="width:100px;max-width:100px" class=" py-4 px-4 text-sm font-medium text-gray-500 whitespace-nowrap dark:text-white cursor-pointer " >
                         <a style="width:100px;max-width:100px" class="inline-block px-4 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg  focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out mr-1.5"
